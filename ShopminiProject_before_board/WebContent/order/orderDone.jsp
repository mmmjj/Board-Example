		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td height="35" class="td_default" align="center">
						<span><fmt:formatNumber value="${oDTO.gPrice * oDTO.gAmount}" type="currency" /></span>원
					</td>
				</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<input type = 'text' id = 'total' value = '<fmt:formatNumber value="${oDTO.gPrice * oDTO.gAmount}" type="currency" />' readonly>원
					</td>
				</tr>
				<tr>
